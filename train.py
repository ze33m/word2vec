...
def collate_fn(batch, dataset):
        ...
        # TODO: подсчёт должен производиться внутри 
...
if __name__ == "__main__":
    ...
    # dl = DataLoader(dataset, batch_size=batch_size, shuffle=False, collate_fn=custom_collate_fn, num_workers = max(1, cpu_count() - 1))
    ...
    #             print(target.shape, context.shape, negatives.shape)
